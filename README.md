About langchain-mcp-adapters-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-mcp-adapters-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-mcp-adapters-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-mcp-adapters
# for installing globally
pixi global install langchain-mcp-adapters
```
...
It is possible to list all of the versions of `langchain-mcp-adapters` available on your platform:
...
```
pixi search langchain-mcp-adapters --channel conda-forge
```
